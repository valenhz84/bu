      ...
      <div class="col-md-12">
          <div class="card"> <!-- start card -->
            <h5 class="card-header">
                <i class="fa fa-calendar"></i> Registar nuevo periodo <a href="{{ url('admin/periods')}}" class="btn btn-success btn-sm float-right"><i class="fas fa-arrow-left"></i> Regresar</a></h5>
                 ...
                 <div class="form-group row">
                       ...
                       <div class="col-md-6">
                         <div class="input-daterange input-group" data-plugin-datepicker>
                           ...
                           <input data-provide="datepicker" data-date-format="yyyy-mm-dd" id="startdate" type="text" class="form-control" name="startdate" value="{{ old('startdate') }}" required autofocus>
                           <div class="input-group-prepend">
                             <div class="input-group-text">a</div>
                           </div>
                           <input data-provide="datepicker" data-date-format="yyyy-mm-dd" id="duedate" type="text" class="form-control" name="duedate" value="{{ old('duedate') }}" required autofocus>
                         </div>
                       </div>
                  </div>
                 <div class="form-group row">
